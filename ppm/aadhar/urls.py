...
urlpatterns = [
    ...
    path('bank/',BankAPI.as_view(), name='bank'),
    path('bank/<int:pk>/',UpdateDestroyBankView.as_view(),name='bankupdate'),
    path('perdet/',PerDetAPI.as_view(), name='perdet'),
    path('perdet/<int:pk>/',UpdateDestroyPerDetAPIView.as_view(),name='perdet'),
]